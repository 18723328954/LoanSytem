  ...
  <div class="app-container">
    <div class="manage-table">
      <el-form
        ...
        size="small">
        <el-form-item>
          <el-input v-model="userName" placeholder="请输入战区员工名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="departmentInformation" style="margin-top: 20px;">
      <div class="manage-table">
        <el-table :data="tableData">
          <el-table-column label="战区编号" prop="militaryRegionId"></el-table-column>
          <el-table-column label="员工编号" prop="id"></el-table-column>
          <el-table-column label="战区名称" prop="militaryName"></el-table-column>
...
import {getMilitaryRegionTableData} from "@/api/militaryRegion";
...
export default {
  ...
  methods: {
    // 表格数据
    async getTableData() {
      var tableData = (await getMilitaryRegionTableData(this.$store.getters.military_region_id)).data
      // 分页处理
